...
- Udrea Alberto-George — <albertoudrea4@gmail.com> -> security, docker structure for project, handling user authentication and passing JWT
- Vulturescu Vlad — <vlad.vulturescu@yahoo.com> -> front-end, design and aesthetics of the project
...
## Note
- Please switch to branch **4** to check how microservices are implemented
